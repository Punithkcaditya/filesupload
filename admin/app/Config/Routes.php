...
$routes->group('admin', static function ($routes) {
    ...
    $routes->get('isapproved', 'Index::isapproved');
    $routes->get('approvedemployees', 'Index::approvedemployees');
    $routes->get('view_details/(:any)', 'Index::view_details/$1');
    $routes->get('showPdf/(:any)', 'Index::showPdf/$1');
    $routes->get('approvelogin/(:any)', 'Index::approvelogin/$1');
    $routes->get('disapprove/(:any)', 'Index::disapprovelogin/$1');
    // $routes->get('reject/(:any)', 'Index::reject/$1');
    $routes->match(['post'], 'reject', 'Index::reject');
 ...
 // Introduction 
    // $routes->get('introduction', 'Index::Introduction');
    $routes->match(['post'], 'introduction', 'Index::Introduction');
    $routes->match(['post'], 'updateemployeedetails', 'Index::updateemployeedetails');
     //Employees
    $routes->match(['post'], 'addemployeedetails', 'Index::addemployeedetails');
